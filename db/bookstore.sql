...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (2, 'vue.js', 'vue.s', 'vue.s', 1000, '58e2d6c5346e41b88f38d3caafea82e8.jpg', 4, 3, '啊嘎嘎', 1, '6');
...
CREATE TABLE `log`  (
  ...
  `bid` int(0) NULL DEFAULT NULL COMMENT '书的id',
...
-- Records of log
-- ----------------------------
INSERT INTO `log` VALUES (1, '2021-06-16', 6, 'dsa', '100', 0, '1223', NULL);
