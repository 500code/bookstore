...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (2, 'vue.js', 'vue.s', 'vue.s', 1000, '58e2d6c5346e41b88f38d3caafea82e8.jpg', 4, 4, '啊嘎嘎', 1);
INSERT INTO `book` VALUES (3, '粉丝度', 'vue.js', 'mybati-plus', 12232, '572436466762405d95be041051a7cae6.jpeg', 1, 1, '', 2);
INSERT INTO `book` VALUES (4, '1223', '二', 'jquery', 1231, 'e4926c6a82f7410c85a805692fc76ea1.jpeg', 1, 1, '', 3);
INSERT INTO `book` VALUES (5, '生世世', '犯得上地方', 'springboot', 122312, 'b14b1f3297db410f8ac45bc36e671f41.jpeg', 1, 1, '', 2);
INSERT INTO `book` VALUES (6, '撒旦发射点', '非法手段', 'sdfsdj', 2312312, 'a0e6857e98104629b4f7838d3708ed65.jpeg', 1, 1, '', 4);
INSERT INTO `book` VALUES (7, '发个大的', '粉丝度', 'df', 23123, '5433cde488cb4d7a8a17addc8fd7c9e5.jpeg', 1, 1, '', 5);
INSERT INTO `book` VALUES (8, '大苏打', 'd发', '123123,手动阀', 123123, '74d17e504e9844d89381ab65e21d46a4.jpeg', 1, 1, '', 7);
INSERT INTO `book` VALUES (9, '胜多负少', '发送', '2132,手动阀手动阀', 12312, '7ca6181b25f24edeb4c1aa9dc71c4b30.jpeg', 1, 1, '', 1);
INSERT INTO `book` VALUES (10, '但是发射点', '速度为', '2342,是的', 12312, 'd203703b68c64681959c7510b67323ab.jpg', 1, 1, '', 10);
INSERT INTO `book` VALUES (11, '发大水', '士大夫', '111,顺丰', 1111, '807d5348d3b14fba804e7dea0b229709.jpg', 1, 1, '', 11);
INSERT INTO `book` VALUES (12, '得打发士', '地方', '是的', 123, 'e41af26096824f168523b1ebcbe2dc72.jpeg', 1, 1, '', 22);
INSERT INTO `book` VALUES (13, 'dsf', 'asdf', 'asdfdsa,sdfadsf', 100, '0d4e2e2e36784a4c885036ade2aadc7f.jpg', 3, 3, 'dsfdsafdsfads', 5);
...
CREATE TABLE `log`  (
  ...
  `operating` int(10) NULL DEFAULT NULL COMMENT '还书0 借书1',
...
CREATE TABLE `user`  (
  ...
  `reputation` int(10) NULL DEFAULT 100 COMMENT '信誉',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '肥宝', '123123', NULL, 5, 2, 100, 1, NULL, 100, NULL);
...
INSERT INTO `user` VALUES (6, 'dsa', '123123', NULL, 5, 1, 0, 3, NULL, 100, NULL);
