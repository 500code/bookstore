...
CREATE TABLE `book`  (
  `bid` int(0) NOT NULL AUTO_INCREMENT COMMENT '书的id',
  ...
  `record` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '现在被谁借了 uid用，分开',
...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (2, 'vue.js', 'vue.s', 'vue.s', 1000, '58e2d6c5346e41b88f38d3caafea82e8.jpg', 4, 0, '啊嘎嘎', 5, '6,6,6,6');
INSERT INTO `book` VALUES (3, '粉丝度', 'vue.js', 'mybati-plus', 12232, '572436466762405d95be041051a7cae6.jpeg', 5, 0, '', 7, '6,6');
INSERT INTO `book` VALUES (4, '1223', '二', 'jquery', 1231, 'e4926c6a82f7410c85a805692fc76ea1.jpeg', 1, 1, '', 3, NULL);
...
INSERT INTO `book` VALUES (7, '发个大的', '粉丝度', 'df', 23123, '5433cde488cb4d7a8a17addc8fd7c9e5.jpeg', 1, 1, '', 5, NULL);
...
INSERT INTO `book` VALUES (10, '但是发射点', '速度为', '2342,是的', 12312, 'd203703b68c64681959c7510b67323ab.jpg', 1, 1, '', 10, NULL);
INSERT INTO `book` VALUES (11, '发大水', '士大夫', '111,顺丰', 1111, '807d5348d3b14fba804e7dea0b229709.jpg', 1, 1, '', 11, NULL);
INSERT INTO `book` VALUES (12, '得打发士', '地方', '是的', 123, 'e41af26096824f168523b1ebcbe2dc72.jpeg', 1, 1, '', 22, NULL);
...
CREATE TABLE `log`  (
  ...
  `operating` int(0) NULL DEFAULT NULL COMMENT '还书0 借书1',
  `bname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '书名',
...
-- Records of log
-- ----------------------------
INSERT INTO `log` VALUES (1, '2021-06-16', 6, 'dsa', '100', 1, 'vue.js');
...
CREATE TABLE `user`  (
  ...
  `num` int(0) NULL DEFAULT NULL COMMENT '当前借了几次书',
  ...
  `reputation` int(0) NULL DEFAULT 100 COMMENT '信誉',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '肥宝', '123123', NULL, 5, 3, 101, 1, NULL, 100, '3');
...
INSERT INTO `user` VALUES (6, 'dsa', '123123', NULL, 5, 5, 8, 3, NULL, 100, '3,2,2,2,2');
