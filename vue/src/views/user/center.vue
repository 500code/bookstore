          ...
          <el-card shadow="hover">
            <div class="user-info">
              ...
              <div class="user-info-cont ">
                ...
                <div class="user-info-count ">借书总次数：<span class="user-info-imp">{{ user.ucount }}</span></div>
                <div class="user-info-rep">信誉度：<span class="user-info-imp">{{ user.reputation }}</span></div>
                <div class="user-info-rep">可借次数：<span class="user-info-imp">{{ user.num }}/5</span></div>
              </div>
            </div>
          </el-card>
          <el-table
